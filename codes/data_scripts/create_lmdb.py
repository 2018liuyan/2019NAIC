...
def REDS(mode):
    ...
    BATCH = 5000  # After BATCH images, lmdb commits, if read_all_imgs = False
    if mode == 'train_sharp':
        img_folder = '/root/ly33/mytorch/2019NAIC-challenge/naic-2019/mmsr/datasets/REDS/train_sharp/000'
        lmdb_save_path = '/root/ly33/mytorch/2019NAIC-challenge/naic-2019/mmsr/datasets/REDS/train_sharp/lmdb/'
