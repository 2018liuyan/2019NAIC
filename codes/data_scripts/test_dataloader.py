...
def main():
    ...
    if dataset == 'REDS':
        opt['name'] = 'test_REDS'
        opt['dataroot_GT'] = '/root/group-video-quality-enhance/NAIC/data/partial_data/lmdb'
        opt['dataroot_LQ'] = '/root/group-video-quality-enhance/NAIC/data/partial_data/lmdb'
        opt['mode'] = 'REDS'
        opt['N_frames'] = 5
        opt['phase'] = 'train'
